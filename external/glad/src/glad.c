/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun Jul 26 12:19:55 2026.
    ...
    Commandline:
        --profile="compatibility" --api="gl=2.0" --generator="c" --spec="gl" --extensions="GL_ARB_debug_output,GL_ARB_framebuffer_object"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D2.0&extensions=GL_ARB_debug_output&extensions=GL_ARB_framebuffer_object
*/
