...
CSaveGameDialog::CSaveGameDialog(vgui2::Panel *parent)
    : vgui2::Frame(parent, "SaveGameDialog")
{
	...
	new vgui2::Label(this, "HelpText", "#GameUI_SaveGameHelp");

	vgui2::Button *savegame = new vgui2::Button(this, "Save", "#GameUI_Save");
...
void CSaveGameDialog::CreateSavedGamesList(void)
{
	...
	m_pGameList->AddColumnHeader(0, "Game", "#GameUI_SavedGame", 175, true);
	m_pGameList->AddColumnHeader(1, "Type", "#GameUI_Type", 100, true);
	m_pGameList->AddColumnHeader(2, "Elapsed Time", "#GameUI_ElapsedTime", 75, true);
	m_pGameList->AddColumnHeader(3, "Time", "#GameUI_TimeStamp", 175, true);
...
int TimeStampSortFunc(const void *elem1, const void *elem2)
{
	...
	p1 = *(vgui2::ListPanelItem **)elem1;
	p2 = *(vgui2::ListPanelItem **)elem2;
	assert(p1 && p2);
...
void CSaveGameDialog::ScanSavedGames(void)
{
	...
	char const *pFileName = g_pFullFileSystem->FindFirst(szDirectory, &handle);
	while (pFileName)
	{
