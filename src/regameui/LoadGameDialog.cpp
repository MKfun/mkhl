...
CLoadGameDialog::CLoadGameDialog(vgui2::Panel *parent)
    : vgui2::Frame(parent, "LoadGameDialog")
{
	...
	new vgui2::Label(this, "HelpText", "#GameUI_LoadGameHelp");

	vgui2::Button *load = new vgui2::Button(this, "Load", "#GameUI_Load");
