...
{
public:
	CServerDescription(vgui2::PanelListPanel *panel);
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CCreateMultiplayerGameGameplayPage::CCreateMultiplayerGameGameplayPage(vgui2::Panel *parent, const char *name)
    : PropertyPage(parent, name)
{
	m_pOptionsList = new vgui2::PanelListPanel(this, "GameOptions");
...
void CCreateMultiplayerGameGameplayPage::LoadGameOptionsList()
{
	...
	while (pObj)
	{
		...
		m_pOptionsList->AddItem(new vgui2::Label(this, "", ""), pCtrl);
...
//-----------------------------------------------------------------------------
CServerDescription::CServerDescription(vgui2::PanelListPanel *panel)
    : CDescription(panel)
{
