...
public:
	// Construction
	CHudElementHelper(CHudElem *(*pfnCreate)(void), int depth);
...
#define DECLARE_HUDELEMENT(className)         \
	static CHudElem *Create_##className(void) \
	{                                         \
...
#define DECLARE_MULTIPLY_INHERITED()                                                            \
	...
	{                                                                                           \
		return CHudElem::operator new(stAllocateBlock);                                         \
	}                                                                                           \
	void *operator new(size_t stAllocateBlock, int nBlockUse, const char *pFileName, int nLine) \ \
	{                                                                                           \
		return CHudElem::operator new(stAllocateBlock, nBlockUse, pFileName, nLine);            \
	}                                                                                           \
	void operator delete(void *pMem)                                                            \
	{                                                                                           \
		CHudElem::operator delete(pMem);                                                        \
	}                                                                                           \
	void operator delete(void *pMem, int nBlockUse, const char *pFileName, int nLine)           \
	{                                                                                           \
		CHudElem::operator delete(pMem, nBlockUse, pFileName, nLine);                           \
	}
