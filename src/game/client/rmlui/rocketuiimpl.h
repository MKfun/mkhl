...
protected:
    ...
    void     m_togglePauseMenuFunc();

    // List of Document Reload functions for hot-reloading.
    CUtlVector<documentReloadFuncs*> m_documentReloadFuncs;
...
public:
    ...
    // Feed input into UI
    virtual bool HandleInputEvent( bool keyDown, int keyNumber, const char *bindName );
    ...
    virtual Rml::ElementDocument *LoadDocumentFileIntoHud( const char *tag, const char *pPath, const char *filepath,
        documentReloadFuncs* m_pReloadDocumentFuncs);
