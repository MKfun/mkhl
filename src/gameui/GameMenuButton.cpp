...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CGameMenuButton::CGameMenuButton(vgui2::Panel *parent, const char *panelName, const char *text)
								: vgui2::MenuButton( parent, panelName, text )
{
	g_pGameMenuButton = this;
	vgui2::Menu *gameMenu = NULL;
	...
	else
	{
		...
		gameMenu = new vgui2::Menu(this, "GameMenu");
...
//-----------------------------------------------------------------------------
vgui2::Menu *CGameMenuButton::RecursiveLoadGameMenu(KeyValues *datafile)
{
	Menu *menu = new vgui2::Menu(this, datafile->GetName());
...
//-----------------------------------------------------------------------------
void CGameMenuButton::PositionDialog(vgui2::PHandle dlg)
{
	if (!dlg.Get())
		return;
