...
{
public:
	CGameMenuItem(vgui2::Panel *parent, const char *name)  : BaseClass(parent, name, "GameMenuItem")
	{
...
private:
	...
	typedef vgui2::MenuItem BaseClass;
};
...
{
public:
	CGameMenu(vgui2::Panel *parent, const char *name) : vgui2::Menu(parent, name)
	{
...
struct vgui2::PanelMessageMap* CTaskbar::GetMessageMap(){
	return NULL;
}
/*
...
void CTaskbar::OnOpenQuitConfirmationDialog()
{
	...
	box->DoModal();
	vgui2::surface()->RestrictPaintToSinglePanel(box->GetVPanel());
}
