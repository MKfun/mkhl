...
//-----------------------------------------------------------------------------
CNewGameDialog::CNewGameDialog(vgui2::Panel *parent) : CTaskFrame(parent, "NewGameDialog")
{
	...
	new vgui2::Label( this, "HelpText", "#GameUI_NewGameHelpText" );
	...
	vgui2::Button *play = new vgui2::Button( this, "Play", "#GameUI_Play" );
